...
insert into species values('Cão','O cão (nome científico: Canis lupus familiaris),[1] no Brasil também chamado de cachorro, é um mamífero carnívoro da família dos canídeos, subespécie do lobo, e talvez o mais antigo animal domesticado pelo ser humano.');
	/*cão*/
...
insert into generalization_species values('Cão','Mammal');
...
insert into generalization_species values('Afegão Hound','Cão');
insert into generalization_species values('Affenpinscher','Cão');
insert into generalization_species values('Airedale Terrier','Cão');
insert into generalization_species values('Akita','Cão');
insert into generalization_species values('American Staffordshire Terrier','Cão');
insert into generalization_species values('Basenji','Cão');
insert into generalization_species values('Basset Hound','Cão');
insert into generalization_species values('Beagle','Cão');
insert into generalization_species values('Beagle Harrier','Cão');
insert into generalization_species values('Bearded Collie','Cão');
insert into generalization_species values('Bedlington Terrier','Cão');
insert into generalization_species values('Bichon Frisé','Cão');
insert into generalization_species values('Bloodhound','Cão');
insert into generalization_species values('Bobtail','Cão');
insert into generalization_species values('Boiadeiro Australiano','Cão');
insert into generalization_species values('Boiadeiro Bernês','Cão');
insert into generalization_species values('Border Collie','Cão');
insert into generalization_species values('Border Terrier','Cão');
insert into generalization_species values('Borzoi','Cão');
insert into generalization_species values('Boston Terrier','Cão');
insert into generalization_species values('Boxer','Cão');
insert into generalization_species values('Buldogue Francês','Cão');
insert into generalization_species values('Buldogue Inglês','Cão');
insert into generalization_species values('Bull Terrier','Cão');
insert into generalization_species values('Bulmastife','Cão');
insert into generalization_species values('Cairn Terrier','Cão');
insert into generalization_species values('Cane Corso','Cão');
insert into generalization_species values('Cão de Água Português','Cão');
insert into generalization_species values('Cão de Crista Chinês','Cão');
insert into generalization_species values('Cavalier King Charles Spaniel','Cão');
insert into generalization_species values('Chesapeake Bay Retriever','Cão');
insert into generalization_species values('Chihuahua','Cão');
insert into generalization_species values('Chow Chow','Cão');
insert into generalization_species values('Cocker Spaniel Americano','Cão');
insert into generalization_species values('Cocker Spaniel Inglês','Cão');
